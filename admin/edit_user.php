...
<head>
    ...
    <title>Redziģēt lietotāju</title>
    ...
    <div class="container">
        <div class="card" style="max-width: 600px; margin: 0 auto;">
            ...
            <form method="POST" action="">
                ...
                <div class="form-group">
                    <label for="role">Status jeb tiesības</label>
                    <select id="role" name="role" class="form-control" required>
                        <option value="user" <?php echo $user_data['role'] === 'user' ? 'selected' : ''; ?>>User</option>
                        <option value="admin" <?php echo $user_data['role'] === 'admin' ? 'selected' : ''; ?>>Admin</option>
                    </select>
                    <small class="form-text">btw.. vienmēr jāpaliek vizmaz vienam adminam, savādāk būs tikai parastie useri. :D</small>
                </div>

                <div class="form-group">
                    <label>Lietotājs izveidots</label>
                ...
                <div class="d-flex gap-2">
                    <button type="submit" class="btn btn-primary">Atjaunot lietotāju</button>
